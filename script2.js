window.onload = function(e) {
  ...
  Promise.all(fontPromises).then(function() {
    /* This loads your project from prototypo */
    const yourFontName = 'Wide Grotesk';
    window['prototypo-projects'].getProjects('design@prototypo.test', 'prototypo')
      .then(function(fonts) {
        const myFont = fonts.find(f => f.name === yourFontName);

        Ptypo.changeAllParams(myFont.variants[0].values, 'my-font');
      });
